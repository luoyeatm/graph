...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            "onUpdate:current"?: (...args: any[]) => any;
            "onUpdate:pageSize"?: (...args: any[]) => any;
        }> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "locale" | "prefixCls" | "onChange" | "role" | "current" | "size" | "showSizeChange" | "total" | "defaultCurrent" | "defaultPageSize" | "pageSize" | "buildOptionText" | "selectPrefixCls" | "itemRender" | "onShowSizeChange" | "onUpdate:current" | "onUpdate:pageSize">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
